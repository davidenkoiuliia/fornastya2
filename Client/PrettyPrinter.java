...
public class PrettyPrinter {
    ...
    public static void printBandList(List<Band> bandList) {
        printBandParamNames();
    ...
    public static void printBandListAlbumsCount(List<Band> bandList) {
        System.out.printf(bandIDFormat, "ID");
        System.out.printf(bandNameFormat, "movieName");
