...
public class ReplaceIfGreater extends AbstractCommand {
    ...
    public ReplaceIfGreater(ConsoleClient client, Receiver receiver, Integer id, String name,Integer x,
                         Float y, int albumsCount, MusicGenre genre,
                         int numberOfParticipants, String studioName, String studioAddress, LocalDateTime creationDate) {
    ...
    public void execute() throws CollectionKeyException, WrongArgumentException {
        receiver.replaceIfGreater (id, name, x, y, albumsCount, genre,
