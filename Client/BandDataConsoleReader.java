...
public class BandDataConsoleReader {
    public static String readBandName(BasicReader basicReader, boolean inScriptMode) throws InvalidScriptException {
        ...
        while (bandName == null) {
            try {
                String input = basicReader.readLine("Enter band name");
                bandName = input.trim();
    ...
    public static Integer readID(BasicReader basicReader, boolean inScriptMode) throws InvalidScriptException {
        Integer x = null;
        boolean xSuccess = false;
        while (!xSuccess) {
            try {
                String input = basicReader.readLine("Enter ID");
                String xInput = input.trim();
                x = Integer.parseInt(xInput);
                xSuccess = true;
            } catch (NumberFormatException e) {
