...
public class BandDataConsoleReader {
    ...
    public static LocalDateTime readCreationDate(BasicReader basicReader, boolean inScriptMode) throws InvalidScriptException {
        LocalDateTime birthday = null;
        while (birthday == null) {
            try {
                String input = basicReader.readLine("Enter date of band's creation in DD.MM.YYYY format");
